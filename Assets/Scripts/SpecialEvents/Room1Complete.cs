...
using UnityEngine;
public class Room1Complete : SpecialEvents
{
    ...
    {
        string message1 = "Good Job! On to the next one!";
    ...
    public override void eventAction()
    {
        if (!occured)
        {
            ...
            if (room.checkPoints() >= 2)
            {
                ...
                cc.setupCutscene("Room1PuzzleDone", showcaseCams, mainCam);
